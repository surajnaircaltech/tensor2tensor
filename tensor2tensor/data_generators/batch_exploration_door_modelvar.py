...
class BatchExplorationDoorModelvar(video_utils.VideoProblem):
    ...
    def generate_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        for i in range(5): # Number of seeds
            for j in range(4): # Number of buffers per seed
                path = '/iris/u/asc8/taskexp/our-smm/exps/07_19_door/modelvar_tm_c_sep__seed{}_door_grads1/img_memory/{}mem.hdf5'.format(i, j)
