...
class BatchExplorationBlock0Modelvar(video_utils.VideoProblem):
    ...
    def generate_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        for i in range(5): # Number of seeds
            for j in range(4): # Number of buffers per seed
                path = '/iris/u/hjnam/task_exp/batch_exploration/exps/08_15_block0/modelvar__seed{}_block0/img_memory/{}mem.hdf5'.format(i, j)
