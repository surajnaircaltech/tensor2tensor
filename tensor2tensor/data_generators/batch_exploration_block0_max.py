...
class BatchExplorationBlock0Max(video_utils.VideoProblem):
    ...
    def total_number_of_frames(self):
        return 5*4*25000 + 10*25000 #10k our method + 5k random
    ...
    def generate_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        for i in range(5): # Number of seeds
            for j in range(4): # Number of buffers per seed
                path = '/iris/u/hjnam/task_exp/batch_exploration/exps/08_15_block0/max_sn__seed{}_block0/img_memory/{}mem.hdf5'.format(i, j)
#                 path= DATA_URL
